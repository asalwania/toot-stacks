...
export const metadata: Metadata = {
  title: "Blog",
  description:
    "Tips, tutorials, and updates from the ToolsStack team. Learn how to make the most of our developer tools.",
};
      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Tips, tutorials, and updates from the ToolsStack team.
          </p>
        </div>
